...
API_ID = int(environ.get('API_ID', '22111802'))
API_HASH = environ.get('API_HASH', 'a0fae5f963370bc40beae62421a4991d')
BOT_TOKEN = environ.get('BOT_TOKEN', "6239857776:AAHz_q2AsNjQ9Gex8BdGgBxZlgTaK_WB_bU")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002376648064'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5003566796').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002488883799').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://robinrobi12597:mvjhtnK70W5POUgw@robin.ngiji.mongodb.net/?retryWrites=true&w=majority&appName=Robin")
...
REFERAL_COUNT = int(environ.get('REFERAL_COUNT', '')) # number of referal count
